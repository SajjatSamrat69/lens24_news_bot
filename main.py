...
def run_portal():
    ...
    for niche, feed_url in FEEDS.items():
        ...
        # Grab the single freshest breaking entry item from the feed layout
        ...
        try:
            ...
            # Direct pipeline push straight into your site layout configuration
...
if __name__ == '__main__':
    run_portal()
    print("🏁 Task execution finished cleanly.")
